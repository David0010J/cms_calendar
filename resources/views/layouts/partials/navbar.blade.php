        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="{{ route('dashboard') }}">
                ...
                <b>
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{ asset('build/assets/images/logo-icon.png') }}" alt="homepage" class="dark-logo" />
                    <!-- Light Logo icon -->
                ...
                <span>
                    <!-- dark Logo text -->
                    <img src="{{ asset('build/assets/images/logo-text.png') }}" alt="homepage" class="dark-logo" />
                    <!-- Light Logo text -->
                    <img src="{{ asset('build/assets/images/logo-light-text.png') }}" class="light-logo" alt="homepage" /></span>
            </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                        ...
                        <img src="{{ asset('build/assets/images/users/4.jpg') }}" alt="user" class="profile-pic" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-right animated flipInY">
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="{{ asset('build/assets/images/users/4.jpg') }}" alt="user"></div>
                                    <div class="u-text">
                                        <h4>{{ Auth::user()->name }}</h4> <!-- Display user name -->
                                        <p class="text-muted">{{ Auth::user()->email }}</p> <!-- Display user email -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu  dropdown-menu-right animated bounceInDown"> <a
                            class="dropdown-item" href="#"><i class="flag-icon flag-icon-in"></i>
                            India</a> <a class="dropdown-item" href="#"><i
                                class="flag-icon flag-icon-fr"></i> French</a> <a class="dropdown-item"
                            href="#"><i class="flag-icon flag-icon-cn"></i> China</a> <a
                            class="dropdown-item" href="#"><i class="flag-icon flag-icon-de"></i>
                            Dutch</a> </div>
                </li>
            </ul>
        </div>
