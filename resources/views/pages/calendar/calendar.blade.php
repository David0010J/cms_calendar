                            ...
                            <div class="tab-pane fade show active" id="top-home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="d-flex justify-content-end mt-3 col-sm-12">
                                        <button
                                            class="btn btn-outline-primary me-3 border-3 d-flex align-items-center px-4 py-2 rounded-pill"
                                            type="button">
                                                        ...
                                                        <tbody>
                                                            @foreach ($publicHolidays as $holiday)
                                                                <tr>
                                                                    ...
                                                                    </td> <!-- Format date as you want -->
                                                                    <td>{{ $holiday->name }}</td>
                                                                    <td>{{ $holiday->lang }}</td>
                                                                    <!-- You can add actions here if necessary -->
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
