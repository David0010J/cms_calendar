<div class="page-header sidebar-fontello">
                ...
                <ul class="header-left">
                    <li class="onhover-dropdown"> <span class="f-w-600">Dashboard</span><span><i class="middle"
                        ...
                        <ul class="onhover-show-div left-dropdown">
                            ...
                            <li class="flyout-right"><a href="javascript:void(0)">Attendance</a>
                                <ul>
                                    <li> <a href="#">Boxed</a></li>
                                    <li> <a href="#">RTL</a></li>
                                </ul>
                            </li>
                            <li class="flyout-right"><a href="javascript:void(0)">Leave</a>
                                <ul>
            ...
            <ul class="nav-menus">
                ...
                <li class="language-nav">
                    <div class="translate_wrapper">
                        ...
                        <div class="more_lang">
                            <div class="lang" data-value="kh"><i class="flag-icon flag-icon-kh"></i><span
                                    class="lang-txt">Khmer</span>(KH)</div>
