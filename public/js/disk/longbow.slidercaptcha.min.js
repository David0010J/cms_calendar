        ...
        (n.initImg = function () {
            ...
            (r.onload = function () {
                (t.x = s(n + 10, t.options.width - (n + 10))),
                    (t.y = s(
                        10 + 2 * t.options.sliderR,
                        t.options.height - (n + 10)
                    )),
                    o(t.canvasCtx, "fill"),
                    o(t.blockCtx, "clip"),
                    t.canvasCtx.drawImage(
                        r,
                        0,
                        0,
                        t.options.width - 2,
            ...
            this.$element.addEventListener("selectstart", function () {
                ...
                this.refreshIcon.addEventListener("click", function () {
                    (t.text.textContent = t.options.barText),
                        t.reset(),
                        e(t.options.onRefresh) &&
                            t.options.onRefresh.call(t.$element);
                });
            var i,
                n,
                o = [],
                ...
                a = function (e) {
                    ...
                    var c =
                        ((t.options.width - 40 - 20) / (t.options.width - 40)) *
                        l;
                    (t.block.style.left = c + "px"),
                        t.sliderContainer.classList.add(
                ...
                l = function (n) {
                    ...
                    if (
                        ((s = !1),
                        (n.clientX || n.changedTouches[0].clientX) === i)
                    )
                        return !1;
                    ...
                    r.spliced && r.verified
                        ? (t.sliderContainer.classList.add(
                          ...
                          e(t.options.onSuccess) &&
                              t.options.onSuccess.call(t.$element))
                        : (t.sliderContainer.classList.add(
                              "sliderContainer_fail"
                          ),
                          e(t.options.onFail) &&
                              t.options.onFail.call(t.$element),
                          setTimeout(function () {
                              (t.text.innerHTML = t.options.failedText),
                                  t.reset();
                          }, 1e3));
                };
